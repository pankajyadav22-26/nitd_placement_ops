...
export default function UploadEligibleMtech() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch("/api/coordinator/mtech2027/defaultFormat/upload", {
        method: "POST",
        body: formData,
      });
  ...
  return (
    <div className="h-auto bg-gradient-to-br from-[#4a90e2] to-[#ff9a76] flex items-center justify-center p-15 rounded-xl">
      <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-black font-sans">
        <h2 className="text-2xl font-bold mb-6 text-center text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-indigo-600">
          Upload Interested Students (M.Tech)
        </h2>
