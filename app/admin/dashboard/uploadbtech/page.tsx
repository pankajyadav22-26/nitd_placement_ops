...
export default function UploadBtechPage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/admin/students/btech/upload", {
        method: "POST",
  ...
  return (
    <div className="p-10 rounded-xl shadow-2xl bg-gradient-to-br from-[#4a90e2] to-[#ff9a76] text-white text-center transition-all duration-400 overflow-hidden font-poppins h-auto">
      ...
      <div className="mt-10 bg-white text-[#2e2e2e] rounded-xl p-6 shadow-lg text-left max-w-3xl mx-auto">
