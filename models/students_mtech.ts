...
const MtechStudentSchema = new Schema<MtechStudent>(
  {
    ...
    btech_passing_year: { type: Number, required: true },
...
const MtechStudentModel =
  models?.MtechStudent || model<MtechStudent>("MtechStudent", MtechStudentSchema);

export default MtechStudentModel;